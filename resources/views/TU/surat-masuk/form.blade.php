...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('tanggal_masuk', $tuSuratMasuk->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('perihal', $tuSuratMasuk->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        @if (is_string($tuSuratMasuk->lampiran))
        <a href="{{ $tuSuratMasuk->lampiran }}">Download file</a>
        @endif
    </div>
</div>
