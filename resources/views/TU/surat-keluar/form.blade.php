...
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">tuSuratKeluar <b>nama</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    <label class="form-label">   {{ Form::label('tanggal_masuk') }}</label>
    <div>
        {{ Form::text('tanggal_masuk', $tuSuratKeluar->tanggal_masuk, ['class' => 'form-control' .
        ...
        <small class="form-hint">tuSuratKeluar <b>tanggal_masuk</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
