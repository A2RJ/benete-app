<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('nama', $tuSuratTugas->nama, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('tanggal_masuk', $tuSuratTugas->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('asal', $tuSuratTugas->asal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('perihal', $tuSuratTugas->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        @if (is_string($tuSuratTugas->lampiran))
        <a href="{{ $tuSuratTugas->lampiran }}">Download file</a>
        @endif
    </div>
</div>
