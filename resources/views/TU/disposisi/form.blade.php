<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('tujuan', $tuDisposisi->tujuan, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('batas_waktu_tindaklanjuti', $tuDisposisi->batas_waktu_tindaklanjuti, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::select('jenis_disposisi', ['Segera' => 'Segera', 'Biasa' => 'Biasa'], $tuDisposisi->jenis_disposisi, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::select('status_disposisi', ['Belum Ditindaklanjuti' => 'Belum Ditindaklanjuti', 'Selesai' => 'Selesai', 'Terlewati' => 'Terlewati'], $tuDisposisi->status_disposisi, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('catatan', $tuDisposisi->catatan, ['class' => 'form-control' .
