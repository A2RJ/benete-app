...
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">tuKontrakKerjaSama <b>nama</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    <label class="form-label">   {{ Form::label('tanggal_masuk') }}</label>
    <div>
        {{ Form::text('tanggal_masuk', $tuKontrakKerjaSama->tanggal_masuk, ['class' => 'form-control' .
        ...
        <small class="form-hint">tuKontrakKerjaSama <b>tanggal_masuk</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">tuKontrakKerjaSama <b>asal</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    <label class="form-label">   {{ Form::label('perihal') }}</label>
    <div>
        {{ Form::text('perihal', $tuKontrakKerjaSama->perihal, ['class' => 'form-control' .
        ($errors->has('perihal') ? ' is-invalid' : ''), 'placeholder' => 'Perihal']) }}
        {!! $errors->first('perihal', '<div class="invalid-feedback">:message</div>') !!}
        <small class="form-hint">tuKontrakKerjaSama <b>perihal</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    <label class="form-label">   {{ Form::label('lampiran') }}</label>
    <div>
        {{ Form::text('lampiran', $tuKontrakKerjaSama->lampiran, ['class' => 'form-control' .
        ($errors->has('lampiran') ? ' is-invalid' : ''), 'placeholder' => 'Lampiran']) }}
        {!! $errors->first('lampiran', '<div class="invalid-feedback">:message</div>') !!}
        <small class="form-hint">tuKontrakKerjaSama <b>lampiran</b> instruction.</small>
    </div>
</div>
