<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('nama', $kesyaDokumenAwakKapal->nama, [
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('tanggal_masuk', $kesyaDokumenAwakKapal->tanggal_masuk, [
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('asal', $kesyaDokumenAwakKapal->asal, [
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('perihal', $kesyaDokumenAwakKapal->perihal, [
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        @if (is_string($kesyaDokumenAwakKapal->lampiran))
        <a href="{{ $kesyaDokumenAwakKapal->lampiran }}">Download file</a>
        @endif
    </div>
</div>
