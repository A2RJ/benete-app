                    ...
                    <div class="table-responsive min-vh-100">
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><input class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select kesyaPatroli"></td>
                                    <td>{{ $kesyaPatrolis->firstItem() + $loop->index }}</td>

                                    <td>{{ $kesyaPatroli->nama }}</td>
                                    <td>{{ $kesyaPatroli->user->name }}</td>
