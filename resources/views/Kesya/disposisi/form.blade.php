<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('tujuan', $kesyaDisposisi->tujuan, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('batas_waktu_tindaklanjuti', $kesyaDisposisi->batas_waktu_tindaklanjuti, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::select('jenis_disposisi', ['Segera' => 'Segera', 'Biasa' => 'Biasa'], $kesyaDisposisi->jenis_disposisi, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::select('status_disposisi', ['Belum Ditindaklanjuti' => 'Belum Ditindaklanjuti', 'Selesai' => 'Selesai', 'Terlewati' => 'Terlewati'], $kesyaDisposisi->status_disposisi, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('catatan', $kesyaDisposisi->catatan, ['class' => 'form-control' .
