...
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">kesyaDisposisi <b>kesya_surat_masuk_id</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">kesyaDisposisi <b>tanggal_disposisi</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">kesyaDisposisi <b>batas_waktu_tindaklanjuti</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">kesyaDisposisi <b>jenis_disposisi</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">kesyaDisposisi <b>status_disposisi</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">kesyaDisposisi <b>komentar</b> instruction.</small>
    </div>
</div>
