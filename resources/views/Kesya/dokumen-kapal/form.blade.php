<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('nama', $kesyaDokumenKapal->nama, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('tanggal_masuk', $kesyaDokumenKapal->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('asal', $kesyaDokumenKapal->asal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('perihal', $kesyaDokumenKapal->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        @if (is_string($kesyaDokumenKapal->lampiran))
        <a href="{{ $kesyaDokumenKapal->lampiran }}">Download file</a>
        @endif
    </div>
</div>
