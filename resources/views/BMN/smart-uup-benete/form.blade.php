<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('nama', $bmnSmartUupBenete->nama, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('tanggal_masuk', $bmnSmartUupBenete->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('asal', $bmnSmartUupBenete->asal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('perihal', $bmnSmartUupBenete->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        @if (is_string($bmnSmartUupBenete->lampiran))
        <a href="{{ $bmnSmartUupBenete->lampiran }}">Download file</a>
        @endif
    </div>
</div>
