...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('tanggal_masuk', $bmnSmartUupBenete->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('perihal', $bmnSmartUupBenete->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('lampiran', $bmnSmartUupBenete->lampiran, ['class' => 'form-control' .
