    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-12 col-md-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('bmn-surat-masuk.create') }}" class="btn btn-primary d-none d-sm-inline-block">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Bmn Surat Masuk</h3>
                    </div>
                                        ...
                                        <div class="btn-list flex-nowrap">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('bmn-surat-masuk.edit',$bmnSuratMasuk->id) }}">
                                                        Edit
                                                    </a>
                                                    <form action="{{ route('bmn-surat-masuk.destroy',$bmnSuratMasuk->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    <div class="card-footer d-flex align-items-center">
                        {!! $bmnSuratMasuks->links('tablar::pagination') !!}
                    </div>
                </div>
            </div>
        </div>
