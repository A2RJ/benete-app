...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('tanggal_masuk', $bmnSuratMasuk->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('perihal', $bmnSuratMasuk->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        @if (is_string($bmnSuratMasuk->lampiran))
        <a href="{{ $bmnSuratMasuk->lampiran }}">Download file</a>
        @endif
    </div>
</div>
