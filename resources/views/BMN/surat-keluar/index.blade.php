    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-12 col-md-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('bmn-surat-keluar.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="card">
                    ...
                    <div class="table-responsive min-vh-100">
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tbody>
                                @forelse ($bmnSuratKeluars as $bmnSuratKeluar)
                                <tr>
                                    <td><input class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select bmnSuratKeluar"></td>
                                    <td>{{ $bmnSuratKeluars->firstItem() + $loop->index }}</td>

                                    <td>{{ $bmnSuratKeluar->nama }}</td>
                                    <td>{{ $bmnSuratKeluar->user->name }}</td>
                    ...
                    <div class="card-footer d-flex align-items-center">
                        {!! $bmnSuratKeluars->links('tablar::pagination') !!}
                    </div>
                </div>
            </div>
        </div>
