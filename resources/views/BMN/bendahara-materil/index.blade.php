    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-12 col-md-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('bmn-bendahara-materil.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="card">
                    ...
                    <div class="table-responsive min-vh-100">
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tbody>
                                @forelse ($bmnBendaharaMaterils as $bmnBendaharaMateril)
                                <tr>
                                    <td><input class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select bmnBendaharaMateril"></td>
                                    <td>{{ $bmnBendaharaMaterils->firstItem() + $loop->index }}</td>
                                        ...
                                        <div class="btn-list flex-nowrap">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{ route('bmn-bendahara-materil.show',$bmnBendaharaMateril->id) }}">
                                                        Detail
                                                    </a>
                                                    <a class="dropdown-item" href="{{ route('bmn-bendahara-materil.edit',$bmnBendaharaMateril->id) }}">
                                                        Ubah
                                                    </a>
                                                    <form action="{{ route('bmn-bendahara-materil.destroy',$bmnBendaharaMateril->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    <div class="card-footer d-flex align-items-center">
                        {!! $bmnBendaharaMaterils->links('tablar::pagination') !!}
                    </div>
                </div>
            </div>
        </div>
