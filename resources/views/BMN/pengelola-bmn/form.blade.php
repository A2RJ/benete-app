...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('tanggal_masuk', $bmnPengelolaBmn->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('perihal', $bmnPengelolaBmn->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('lampiran', $bmnPengelolaBmn->lampiran, ['class' => 'form-control' .
