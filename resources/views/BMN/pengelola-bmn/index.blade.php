                                    ...
                                    @forelse ($bmnPengelolaBmns as $bmnPengelolaBmn)
                                        <tr>
                                            <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                                    aria-label="Select bmnPengelolaBmn"></td>
                                            <td>{{ ++$i }}</td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item"
                                                                href="{{ route('bmn-pengelola-bmn.show', $bmnPengelolaBmn->id) }}">
                                                                View
                                                            </a>
                                                            <a class="dropdown-item"
                                                                href="{{ route('bmn-pengelola-bmn.edit', $bmnPengelolaBmn->id) }}">
                                                                Edit
                                                            </a>
                                                            <form
                                                                action="{{ route('bmn-pengelola-bmn.destroy', $bmnPengelolaBmn->id) }}"
                                                                method="POST">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit"
