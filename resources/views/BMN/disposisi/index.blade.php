    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-12 col-md-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('bmn-disposisi.create') }}" class="btn btn-primary d-none d-sm-inline-block">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Bmn Disposisi</h3>
                    </div>
                    ...
                    <div class="table-responsive min-vh-100">
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tbody>
                                @forelse ($bmnDisposisis as $bmnDisposisi)
                                <tr>
                                    <td><input class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select bmnDisposisi"></td>
                                    <td>{{ ++$i }}</td>
                                        ...
                                        <div class="btn-list flex-nowrap">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{ route('bmn-disposisi.show',$bmnDisposisi->id) }}">
                                                        View
                                                    </a>
                                                    <a class="dropdown-item" href="{{ route('bmn-disposisi.edit',$bmnDisposisi->id) }}">
                                                        Edit
                                                    </a>
                                                    <form action="{{ route('bmn-disposisi.destroy',$bmnDisposisi->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    <div class="card-footer d-flex align-items-center">
                        {!! $bmnDisposisis->links('tablar::pagination') !!}
                    </div>
                </div>
            </div>
        </div>
