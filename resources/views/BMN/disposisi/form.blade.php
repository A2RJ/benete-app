...
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">bmnDisposisi <b>bmn_surat_masuk_id</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">bmnDisposisi <b>tanggal_disposisi</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">bmnDisposisi <b>batas_waktu_tindaklanjuti</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">bmnDisposisi <b>jenis_disposisi</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">bmnDisposisi <b>status_disposisi</b> instruction.</small>
    </div>
</div>
<div class="form-group mb-3">
    ...
    <div>
        ...
        <small class="form-hint">bmnDisposisi <b>komentar</b> instruction.</small>
    </div>
</div>
