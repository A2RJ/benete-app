<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('tujuan', $bmnDisposisi->tujuan, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('batas_waktu_tindaklanjuti', $bmnDisposisi->batas_waktu_tindaklanjuti, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::select('jenis_disposisi', ['Segera' => 'Segera', 'Biasa' => 'Biasa'], $bmnDisposisi->jenis_disposisi, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::select('status_disposisi', ['Belum Ditindaklanjuti' => 'Belum Ditindaklanjuti', 'Selesai' => 'Selesai', 'Terlewati' => 'Terlewati'], $bmnDisposisi->status_disposisi, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('catatan', $bmnDisposisi->catatan, ['class' => 'form-control' .
