<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('nama', $pelabuhanSuratKeluar->nama, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('tanggal_masuk', $pelabuhanSuratKeluar->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('asal', $pelabuhanSuratKeluar->asal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('perihal', $pelabuhanSuratKeluar->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        @if (is_string($pelabuhanSuratKeluar->lampiran))
        <a href="{{ $pelabuhanSuratKeluar->lampiran }}">Download file</a>
        @endif
    </div>
</div>
