...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('tanggal_masuk', $pelabuhanPbm->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('perihal', $pelabuhanPbm->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('lampiran', $pelabuhanPbm->lampiran, ['class' => 'form-control' .
