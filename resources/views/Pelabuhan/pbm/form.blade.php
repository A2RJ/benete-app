<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('nama', $pelabuhanPbm->nama, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('tanggal_masuk', $pelabuhanPbm->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('asal', $pelabuhanPbm->asal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('perihal', $pelabuhanPbm->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        @if (is_string($pelabuhanPbm->lampiran))
        <a href="{{ $pelabuhanPbm->lampiran }}">Download file</a>
        @endif
    </div>
</div>
