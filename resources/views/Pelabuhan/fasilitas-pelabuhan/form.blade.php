...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('tanggal_masuk', $pelabuhanFasilitasPelabuhan->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('perihal', $pelabuhanFasilitasPelabuhan->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('lampiran', $pelabuhanFasilitasPelabuhan->lampiran, ['class' => 'form-control' .
