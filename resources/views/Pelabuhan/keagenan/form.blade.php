...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('tanggal_masuk', $pelabuhanKeagenan->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('perihal', $pelabuhanKeagenan->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('lampiran', $pelabuhanKeagenan->lampiran, ['class' => 'form-control' .
