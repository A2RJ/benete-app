<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('nama', $pelabuhanKeagenan->nama, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('tanggal_masuk', $pelabuhanKeagenan->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('asal', $pelabuhanKeagenan->asal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('perihal', $pelabuhanKeagenan->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        @if (is_string($pelabuhanKeagenan->lampiran))
        <a href="{{ $pelabuhanKeagenan->lampiran }}">Download file</a>
        @endif
    </div>
</div>
