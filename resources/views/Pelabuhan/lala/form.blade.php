...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('tanggal_masuk', $pelabuhanLala->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('perihal', $pelabuhanLala->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('lampiran', $pelabuhanLala->lampiran, ['class' => 'form-control' .
