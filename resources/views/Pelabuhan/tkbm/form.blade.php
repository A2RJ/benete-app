<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('nama', $pelabuhanTkbm->nama, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('asal', $pelabuhanTkbm->asal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        @if (is_string($pelabuhanTkbm->lampiran))
        <a href="{{ $pelabuhanTkbm->lampiran }}">Download file</a>
        @endif
    </div>
</div>
