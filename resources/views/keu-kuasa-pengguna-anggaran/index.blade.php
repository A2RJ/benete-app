                                ...
                                @forelse ($keuKuasaPenggunaAnggarans as $keuKuasaPenggunaAnggaran)
                                    <tr>
                                        <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                                   aria-label="Select keuKuasaPenggunaAnggaran"></td>
                                        <td>{{ ++$i }}</td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item"
                                                           href="{{ route('keu-kuasa-pengguna-anggaran.show',$keuKuasaPenggunaAnggaran->id) }}">
                                                            View
                                                        </a>
                                                        <a class="dropdown-item"
                                                           href="{{ route('keu-kuasa-pengguna-anggaran.edit',$keuKuasaPenggunaAnggaran->id) }}">
                                                            Edit
                                                        </a>
                                                        <form
                                                            action="{{ route('keu-kuasa-pengguna-anggaran.destroy',$keuKuasaPenggunaAnggaran->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
