                                ...
                                @forelse ($kesyabandaran as $kesyabandaran)
                                    <tr>
                                        <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                                   aria-label="Select kesyabandaran"></td>
                                        <td>{{ ++$i }}</td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item"
                                                           href="{{ route('kesyabandaran.show',$kesyabandaran->id) }}">
                                                            View
                                                        </a>
                                                        <a class="dropdown-item"
                                                           href="{{ route('kesyabandaran.edit',$kesyabandaran->id) }}">
                                                            Edit
                                                        </a>
                                                        <form
                                                            action="{{ route('kesyabandaran.destroy',$kesyabandaran->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
