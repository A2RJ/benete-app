...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('tanggal_masuk', $keuBendaharaPenerimaan->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('perihal', $keuBendaharaPenerimaan->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        @if (is_string($keuBendaharaPenerimaan->lampiran))
        <a href="{{ $keuBendaharaPenerimaan->lampiran }}">Download file</a>
        @endif
    </div>
</div>
