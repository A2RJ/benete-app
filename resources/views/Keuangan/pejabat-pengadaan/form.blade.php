...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('tanggal_masuk', $keuPejabatPengadaan->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('perihal', $keuPejabatPengadaan->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        @if (is_string($keuPejabatPengadaan->lampiran))
        <a href="{{ $keuPejabatPengadaan->lampiran }}">Download file</a>
        @endif
    </div>
</div>
