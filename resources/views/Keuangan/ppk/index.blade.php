    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-12 col-md-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('keu-ppk.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        Tambah Pejabat Pembuat Komitmen
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <div class="table-responsive min-vh-100">
                        <table class="table card-table table-vcenter text-nowrap datatable">
                            ...
                            <tbody>
                                @forelse ($keuPpks as $keuPpk)
                                <tr>
                                    <td><input class="form-check-input m-0 align-middle" type="checkbox" aria-label="Select keuPpk"></td>
                                    <td>{{ $keuPpks->firstItem() + $loop->index }}</td>

                                    <td>{{ $keuPpk->nama }}</td>
                                    <td>{{ $keuPpk->user->name }}</td>
                                        ...
                                        <div class="btn-list flex-nowrap">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a class="dropdown-item" href="{{ route('keu-ppk.show',$keuPpk->id) }}">
                                                        Detail
                                                    </a>
                                                    <a class="dropdown-item" href="{{ route('keu-ppk.edit',$keuPpk->id) }}">
                                                        Ubah
                                                    </a>
                                                    <form action="{{ route('keu-ppk.destroy',$keuPpk->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                    ...
                    <div class="card-footer d-flex align-items-center">
                        {!! $keuPpks->links('tablar::pagination') !!}
                    </div>
                </div>
            </div>
        </div>
