<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('tujuan', $keuDisposisi->tujuan, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('batas_waktu_tindaklanjuti', $keuDisposisi->batas_waktu_tindaklanjuti, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::select('jenis_disposisi', ['Segera' => 'Segera', 'Biasa' => 'Biasa'], $keuDisposisi->jenis_disposisi, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::select('status_disposisi', ['Belum Ditindaklanjuti' => 'Belum Ditindaklanjuti', 'Selesai' => 'Selesai', 'Terlewati' => 'Terlewati'], $keuDisposisi->status_disposisi, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('catatan', $keuDisposisi->catatan, ['class' => 'form-control' .
