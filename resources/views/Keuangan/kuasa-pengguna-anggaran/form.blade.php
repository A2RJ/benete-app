...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::date('tanggal_masuk', $keuKuasaPenggunaAnggaran->tanggal_masuk, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::textarea('perihal', $keuKuasaPenggunaAnggaran->perihal, ['class' => 'form-control' .
...
<div class="form-group mb-3">
    ...
    <div>
        ...
        @if (is_string($keuKuasaPenggunaAnggaran->lampiran))
        <a href="{{ $keuKuasaPenggunaAnggaran->lampiran }}">Download file</a>
        @endif
    </div>
</div>
